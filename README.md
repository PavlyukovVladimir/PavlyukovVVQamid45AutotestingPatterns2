...
<details><summary>Развернуть Задача №2: тестовый режим</summary>
...
* Runs server: `java -jar artifacts/app-ibank.jar -P:profile=test`

_на удаленной машине эта команда будет чуть другая `java -jar ./artifacts/app-ibank.jar -P:profile=test &`_
